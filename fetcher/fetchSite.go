...
// ToDo, make some cookie profiles and store cookie sessions
// ToDo, read http://stackoverflow.com/questions/17086065/setting-up-cookies-at-browser-golang
// ToDo, add more referers
	// https://www.bing.com -- works for wsj
...
//response header
// map[Server:[nginx] Cache-Control:[max-age=0, no-cache, no-store] Pragma:[no-cache] X-Ua-Compatible:[IE=edge] Expires:[Fri, 16 Oct 2015 02:32:36 GMT] Set-Cookie:[DJSESSION=country%3Dus%7C%7Ccontinent%3Dna%7C%7Cregion%3Dny%7C%7Ccity%3Dalbany%7C%7CORCS%3Dna%2Cus; Domain=.wsj.com; Path=/ DJCOOKIE=ORC%3Dna%2Cus%7C%7CFCFGOOGLE%3D0%7C%7CFCFEXPGOOGLE%3D1445049156495; Domain=.wsj.com; Path=/; Expires=Sat, 15 Oct 2016 02:32:36 GMT wsjregion=na%2Cus; Domain=.wsj.com; Path=/; Expires=Sun, 15 Nov 2015 02:32:36 GMT test_key=0.7748868635389954; Domain=.wsj.com; Path=/; Expires=Sun, 15 Nov 2015 02:32:36 GMT] Content-Type:[text/html; charset=UTF-8] Date:[Fri, 16 Oct 2015 02:32:36 GMT] Connection:[keep-alive Transfer-Encoding] Vary:[Accept-Encoding] X-Article-Template:[full] X-Powered-By:[Tesla]]
